    ...
    return (
        <form>
            ...
            <div className="action-container">
                <Button handleClick={handleCancel} isDisabled={status === 'isSending'} styleName="btn-secondary">Cancel</Button>
                <Button handleClick={handleSave} isDisabled={status === 'isSending'} styleName="btn-primary">Save</Button>
            </div>
        </form>
    )
}
